 ...
 *
 * <p>Platform Metrics is optional: when {@link MetricsConfiguration#SKAHA_METRICS_BACKEND_URL} is unset (Helm
...
public class MetricsDAO {
     ...
     * @throws UnsupportedOperationException if no platform metrics provider is configured
     */
