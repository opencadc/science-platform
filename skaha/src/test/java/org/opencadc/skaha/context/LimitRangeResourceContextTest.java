...
public class LimitRangeResourceContextTest {
    ...
    public void testCounts() {
        ...
        final LimitRangeResourceContext resourceContext = new LimitRangeResourceContext(containerLimitRange);
        Assert.assertEquals("Wrong CPU count", new IntegerRange(1, 8), resourceContext.getCoreCounts());
        Assert.assertEquals("Wrong CPU count", new IntegerRange(4, 24), resourceContext.getMemoryCounts());
        Assert.assertEquals(
