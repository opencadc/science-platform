...
public class SessionTypeTest {
    ...
    public void testCARTAType() {
        ...
        final SessionType testSubject = SessionType.fromApplicationStringTypeAndImage("carta");
        Assert.assertEquals(
    ...
    public void testNonCARTAType() {
        final String currentWorkingDirectory = System.getProperty("user.home");
        final SessionType testSubject = SessionType.fromApplicationStringTypeAndImage("notebook");
        Assert.assertEquals(
                "Wrong legacy ingress path",
