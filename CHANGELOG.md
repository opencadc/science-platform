...
* add support for posix mapper cache ttl ([fe80bab](https://github.com/opencadc/science-platform/commit/fe80babec8c571a128842b4e7848ca956127e148))
...
* **helm:** add pre-upgrade job to migrate canfar-net session labels ([6c4186d](https://github.com/opencadc/science-platform/commit/6c4186de41d7d6a6a3ff05c51c866574e36198ab))
...
* **skaha:** add dummy MetricsDAO with platform metrics fixture ([c69f3c8](https://github.com/opencadc/science-platform/commit/c69f3c82eb270a036b40deb8e024a8acfbe78a30))
* **skaha:** add HTTP MetricsDAO for platform metrics backend ([b33dd65](https://github.com/opencadc/science-platform/commit/b33dd6516e10dfd07f0c9d6eda9a69a5be0bcd3c))
* **skaha:** add HTTP MetricsDAO for platform metrics backend ([a2e4b40](https://github.com/opencadc/science-platform/commit/a2e4b4072fd4b849f072e9881579fb7a503cc9fc))
* **skaha:** add MetricsDAO seam and platform metrics model ([ac7b82a](https://github.com/opencadc/science-platform/commit/ac7b82a4b1ad4d16de3297ffe4fc8486a0bc01d0))
* **skaha:** add SessionLabelPlan projections for launch labels ([ed61af2](https://github.com/opencadc/science-platform/commit/ed61af200887c9e6909cfbd5fbe7c9ff36884290))
* **skaha:** map platform metrics to ResourceStats cluster fields ([2788ddb](https://github.com/opencadc/science-platform/commit/2788ddb8bf3e0a1be885a8361aa8d82b9c88c7e6))
* **skaha:** OTel Java Agent ([e1c24e3](https://github.com/opencadc/science-platform/commit/e1c24e37a40d811c3b4826c742fdefed804948ee))
* **skaha:** platform stats session ceiling from LimitRange ([98bc3d5](https://github.com/opencadc/science-platform/commit/98bc3d50bd4215751248487f9a35d34c3556bc66))
* **skaha:** platform stats session ceiling from resource context file ([0e9996a](https://github.com/opencadc/science-platform/commit/0e9996af195d5b46d615d4800d1d92061ca6b234))
* **skaha:** return 503 when platform metrics backend fails ([bbfbb7d](https://github.com/opencadc/science-platform/commit/bbfbb7da4bbec2400da2d0c6920872311cf4b743))
* **skaha:** wire otel java agent ([d059d81](https://github.com/opencadc/science-platform/commit/d059d8128384a6b16d9b064764c3da67fe951ec1))
* **skaha:** wire platform stats cluster totals to dummy MetricsDAO ([14d8a87](https://github.com/opencadc/science-platform/commit/14d8a87ee3310b11ecda23ce5d64720e079d11f1))
...
* add annotations support to skaha and javadoc ([f775d4c](https://github.com/opencadc/science-platform/commit/f775d4c5eb8bd7ccbefa5f4b88baff40b9f71933))
...
* **ci:** group Dependabot updates and unblock PR checks ([d6efd20](https://github.com/opencadc/science-platform/commit/d6efd20a9668a871024affae8fa6402ee51b9f1a))
* **ci:** group Dependabot updates and unblock PR checks ([7508c53](https://github.com/opencadc/science-platform/commit/7508c536ec14a7a6d6391b44a9a2d25198839a9d))
...
* fix for carta cookies ([3dedfbb](https://github.com/opencadc/science-platform/commit/3dedfbb487064e55afae576ff52423b9646d88e5))
* fix for carta cookies ([7d4f4e8](https://github.com/opencadc/science-platform/commit/7d4f4e8def85f8a1d47c1c3e0e3297570851ea7e))
...
* fix for how session denied access is conveyed ([953ae8d](https://github.com/opencadc/science-platform/commit/953ae8d997fc6ee9c3297e9ba09a91f55d9b1778))
* fix for how session denied access is conveyed ([100c6c0](https://github.com/opencadc/science-platform/commit/100c6c0aef57162a34911c1277b62e3983133c57))
* fix for int test ([bd0be3a](https://github.com/opencadc/science-platform/commit/bd0be3a7e8dcdb1bada04f0a9701639847ca19fc))
...
* fix for sym link applications ([a0e132f](https://github.com/opencadc/science-platform/commit/a0e132f551148e568755e4c04811f3a875130fa4))
* fix for sym link applications ([7df23bf](https://github.com/opencadc/science-platform/commit/7df23bf6a2d27957642f12cb127c087b4120a561))
...
* fix to reduce calls to posix mapper ([03e2c95](https://github.com/opencadc/science-platform/commit/03e2c95c921e3c031073852ff44cee7846a3dbf9))
* force correct version for skaha release ([4e5d8a3](https://github.com/opencadc/science-platform/commit/4e5d8a356fad1c65efb155c082ec46e7e179954f))
* **helm:** add-only label migration on alpine/kubectl ([7db403f](https://github.com/opencadc/science-platform/commit/7db403f3b2b25ff0e3b463cf51c2496c3e1bfdb6))
* **helm:** dual-label cutover before stripping canfar-net keys ([2654c19](https://github.com/opencadc/science-platform/commit/2654c193a15139e22a1c030cf8ffbf365d1b695a))
* **helm:** migrate canfar-job-fixed|flexible to canfar.net/flavor ([cd31a92](https://github.com/opencadc/science-platform/commit/cd31a922a860a133560469d09c33fe0519f2ca3b))
* **helm:** skip immutable Job pod template label patches ([c2355f0](https://github.com/opencadc/science-platform/commit/c2355f083e86d66c82e89ae2243367fcead90e15))
* hush the linter ([8f22340](https://github.com/opencadc/science-platform/commit/8f22340cfd2af8174753518bb64c835bfbfc5ed8))
* latest chart version ([4852fae](https://github.com/opencadc/science-platform/commit/4852fae08d2a569d8b80058862def0e850b1a9e4))
...
* rename env var ([b5c57ef](https://github.com/opencadc/science-platform/commit/b5c57ef24d8bc5f5797b34e41929f41d7de1fb41))
* renew fix ([cb0e241](https://github.com/opencadc/science-platform/commit/cb0e2416e681303da7448d742be992ae383694e0))
* renew fix ([1eb88b8](https://github.com/opencadc/science-platform/commit/1eb88b8d12bc99388e297e2ea1aeccacbab91be0))
...
* **skaha:** align otel helm values ([d91b3d2](https://github.com/opencadc/science-platform/commit/d91b3d28c48f44115777d089b839588878ed57ac))
* **skaha:** allow `MetricsDAO` without metrics backend configured ([d8128b0](https://github.com/opencadc/science-platform/commit/d8128b074312a5534a3f69da636564db2847b3d3))
* **skaha:** allow MetricsDAO without Metrics backend (CADC-15967) ([c538a2f](https://github.com/opencadc/science-platform/commit/c538a2f4ab219476ae109cad4f88bb86fe64fff1))
...
* **skaha:** lazy Metrics DAO init and correct max RAM formatting ([6722f48](https://github.com/opencadc/science-platform/commit/6722f481fca02f34fc4b544d66399f74334960ed))
* **skaha:** pass through invalid millicore CPU strings in toCoreUnit ([960c1c1](https://github.com/opencadc/science-platform/commit/960c1c171150a25a69b06036830dfb0855969c09))
* **skaha:** repair CI after main merge ([e24e48a](https://github.com/opencadc/science-platform/commit/e24e48ab95af32928dce6e3c23af69626cfc2a8e))
* **skaha:** thread SessionLabelPlan through buildManifest shim ([42f4563](https://github.com/opencadc/science-platform/commit/42f45633308a3f3720268582186003f1e255d2e0))
* **skaha:** treat invalid platform CPU strings as zero cores ([930659c](https://github.com/opencadc/science-platform/commit/930659c05d3703084d95d3df31cb09c02a065575))
...
* small fixes ([b21a249](https://github.com/opencadc/science-platform/commit/b21a2498a473b0c8966c9067288a10e6ef47fdf3))
* update desktop app launcher ([7ce3108](https://github.com/opencadc/science-platform/commit/7ce3108e96eb755a3099e590134e0636505bc348))
* update desktop app launcher ([601117a](https://github.com/opencadc/science-platform/commit/601117a6eeb2e9b24836fa65052323012f441b10))
...
* update resources to match within containers ([8b5658d](https://github.com/opencadc/science-platform/commit/8b5658d646096ffce9b676a7499867716db3ce15))
* update resources to match within containers ([256e34e](https://github.com/opencadc/science-platform/commit/256e34e31d1ae189fa802fc136d1e1873b1fb036))
* update to use labels in code ([ba0877e](https://github.com/opencadc/science-platform/commit/ba0877ecf26c893c5620f1a0e63580c197062aa6))
